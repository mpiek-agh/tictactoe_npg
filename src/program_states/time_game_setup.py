...
class TimeGameSetup(GameSetup):
    def __init__(self):
        ...
        self.menu_entries = [
            ...
            ["time", (("15s", 15), ("30s", 30), ("60s", 60), ("75s", 75), ("90s", 90), ("105s", 105), ("120s", 120),), 10, 1],
    ...
    def get_loop_return(self):
        ...
        player2 = Player(self.entry_value(6), self.entry_value(7), self.entry_value(8), self.entry_value(2))
